...
class AddFilter extends StatefulWidget {
  AddFilter(this.file, this.details, this.output);
  File file;
  List<String> details;
  List output;
  ...
  Future<bool> _onWillPop(context) async {
    return (await showDialog(
      ...
      builder: (context) => new AlertDialog(
        title: new Text('You are exiting to home screen'),
        content: new Text('If you have not saved image, please save. Ignore if saved.'),
        actions: <Widget>[
          new FlatButton(
        ...
        body: SingleChildScrollView(
          child: Container(
            child: imageFile == null
                ? Center(
              child: new Text('No image selected.',style: TextStyle(color: Colors.white),),
            )
                : Column(
                  children: <Widget>[
                    widget.output.length == 0
                      ? Container(
                      width: MediaQuery.of(context).size.width,
                      child: Text('No result found',textAlign: TextAlign.center,style: TextStyle(
                          fontSize: 20,
                      ...
                      : Container(
                      child: widget.output[0]["label"] == "No WAX"
                          ? Padding(
                            padding: EdgeInsets.symmetric(vertical:13.0),
                            child: Text("No Wax Present",textAlign: TextAlign.center,style: TextStyle(
                              fontSize: 20,
                              fontWeight: FontWeight.w600,
                              color: Colors.white
                            ),),
                          ...
                          : Padding(
                            padding: EdgeInsets.symmetric(vertical:13.0),
                            child: Text("${widget.output[0]['label']}% Wax Present", textAlign: TextAlign.center,style: TextStyle(
                                fontSize: 20,
                                fontWeight: FontWeight.w600,
                                color: Colors.white
                            ),),
